...
<Project Type="Project" LVVersion="15008000">
	<Property Name="CCSymbols" Type="Str">HARDWARE,TDTSIM;</Property>
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ACal-Mic Sens Parameters.ctl" Type="VI" URL="../../Type Defs/ACal-Mic Sens Parameters.ctl"/>
			...
			<Item Name="Cal Mic Sensitivity (TDT).vi" Type="VI" URL="../../Cal Mic Sensitivity (TDT).vi"/>
			<Item Name="Cal Stimulus.ctl" Type="VI" URL="../../Type Defs/Cal Stimulus.ctl"/>
			<Item Name="CAL-Load data V1.vi" Type="VI" URL="../../File IO VIs/CAL-Load data V1.vi"/>
			<Item Name="CAL-Load data.vi" Type="VI" URL="../../File IO VIs/CAL-Load data.vi"/>
			<Item Name="CAL-Save data.vi" Type="VI" URL="../../File IO VIs/CAL-Save data.vi"/>
			<Item Name="Cal-Smoothing Parameters.ctl" Type="VI" URL="../../Type Defs/Cal-Smoothing Parameters.ctl"/>
			...
			<Item Name="CRM-Config (PXI).vi" Type="VI" URL="../../SubVIs/CRM-Config (PXI).vi"/>
			<Item Name="CRM-Config (TDT).vi" Type="VI" URL="../../SubVIs/CRM-Config (TDT).vi"/>
			<Item Name="CRM-Config.vi" Type="VI" URL="../../SubVIs/CRM-Config.vi"/>
			...
			<Item Name="Flasher.vi" Type="VI" URL="../../HRTF VIs/Typedefs/Flasher.vi"/>
			...
			<Item Name="HRTF-filt Cluster.ctl" Type="VI" URL="../../HRTF VIs/Typedefs/HRTF-filt Cluster.ctl"/>
			<Item Name="HRTF-Read HRTF Matfile.vi" Type="VI" URL="../../HRTF VIs/SubVIs/HRTF-Read HRTF Matfile.vi"/>
			<Item Name="HRTF-Register Device Dialog Events.vi" Type="VI" URL="../../HRTF VIs/SubVIs/HRTF-Register Device Dialog Events.vi"/>
			<Item Name="HRTF-Result.ctl" Type="VI" URL="../../HRTF VIs/Typedefs/HRTF-Result.ctl"/>
			<Item Name="HRTF-Set Multiplexer (TDT).vi" Type="VI" URL="../../HRTF VIs/SubVIs/HRTF-Set Multiplexer (TDT).vi"/>
			<Item Name="HRTF-State Machine Action.ctl" Type="VI" URL="../../HRTF VIs/Typedefs/HRTF-State Machine Action.ctl"/>
			<Item Name="HRTF-Waveform.ctl" Type="VI" URL="../../HRTF VIs/Typedefs/HRTF-Waveform.ctl"/>
			<Item Name="HRTF-Window Type.ctl" Type="VI" URL="../../HRTF VIs/Typedefs/HRTF-Window Type.ctl"/>
			<Item Name="HRTF-Window.ctl" Type="VI" URL="../../HRTF VIs/Typedefs/HRTF-Window.ctl"/>
			...
			<Item Name="SGDA-Close Hardware.vi" Type="VI" URL="../../../PXI DAQ VIs/Top Level VIs/SGDA VIs/SGDA-Close Hardware.vi"/>
			<Item Name="SGDA-Globals.vi" Type="VI" URL="../../../PXI DAQ VIs/Top Level VIs/SGDA VIs/SGDA-Globals.vi"/>
			<Item Name="SGDA-Initialize Hardware.vi" Type="VI" URL="../../../PXI DAQ VIs/Top Level VIs/SGDA VIs/SGDA-Initialize Hardware.vi"/>
			...
			<Item Name="TDT-Enumerate Channels.vi" Type="VI" URL="../../../PXI DAQ VIs/TDT VIs/TDT-Enumerate Channels.vi"/>
			...
			<Item Name="TDT-Init DAQ.vi" Type="VI" URL="../../../PXI DAQ VIs/TDT VIs/TDT-Init DAQ.vi"/>
			...
			<Item Name="Tone RMS from Mag Spec.vi" Type="VI" URL="../../../Utility VIs/Math VIs/Tone RMS from Mag Spec.vi"/>
			...
			<Item Name="XY to Waveform Cluster (1D).vi" Type="VI" URL="../../../Utility VIs/Conversion VIs/XY to Waveform Cluster (1D).vi"/>
		</Item>
